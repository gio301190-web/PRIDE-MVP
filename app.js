...
async function wallet() {
  ...
  const prdSaleInfo = `
    <section class="card" style="max-width:420px;margin:0 auto 24px;text-align:center;">
      <div class="card-label">ПРОДАНО PRD</div>
      <div class="big-value">${new Intl.NumberFormat("ru-RU").format(soldPrd)}</div>
      <div class="card-label" style="margin-top:14px;">ЦЕНА</div>
      <div class="big-value">$${currentPrice.toFixed(2)}</div>
    </section>
  `;
    ...
    app.innerHTML = `
      ...
      <main class="page">
        ...
        <section class="card" style="max-width:420px;margin:0 auto 24px;text-align:center;">
          ...
          <div class="big-value">${moneyPrd(technikBalance)}</div>
        </section>
