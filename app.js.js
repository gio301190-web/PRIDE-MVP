...
function auth(mode = "login") {
  ...
  const visualContent = isWalletLogin
    ? `
      <div class="eyebrow">HERMES RE:SET</div>
      <h1>HERMES<br>RE:SET</h1>
      <p class="muted">
        Личный финансовый кабинет внутри экосистемы PRIDE.
        Баланс, переводы, займы, доходность — всё в одном месте.
      </p>
    `
    : isAcademyLogin
    ? `
      ...
      <h1>BS ACADEMY</h1>
      <p class="muted">
        Обучение внутри экосистемы PRIDE.
      </p>
    `
    : `
      <div class="eyebrow">PRIDE EDGE</div>
  ...
  const cardEyebrow = isWalletLogin
    ? "ВХОД В HERMES RE:SET"
    : isAcademyLogin
    ? "ВХОД В BS ACADEMY"
    : "ВХОД ДЛЯ ИГРОКОВ";
